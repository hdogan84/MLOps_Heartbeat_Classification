...
##### IMPORTANT: THIS IS THE BACKUP VERSION THAT WORKS (With the correct Docker-Compose). Additionally, this Version is saved as normal app.py in the protected main branch until the microservice architecture is finished.
import sys
